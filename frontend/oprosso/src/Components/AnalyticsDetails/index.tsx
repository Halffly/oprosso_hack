    ...
    setPrototypeData({
      Data: {
        ...
        steps: [
          {
            id: 2,
            title: "Поделиться информацией",
            text: `В приложении 2ГИС воспользоваться функцией «Поделиться информацией» на примере организации Google.
            ...
            endQuestions: ["Заметил ли ты длину пути"],
          },
        ],
      },
      Analytics: {
